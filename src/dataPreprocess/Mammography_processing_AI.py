...
### Mura ###
path = r'..\..\data\AI'
annotations = pd.read_csv(path + '\\annotations\\Dataset_Mammography_AI_annotations.csv')
model_outputs = pd.read_csv(path + '\\model_outputs\\Dataset_Mammography_AI_model_outputs.csv')
dicom_metadata = pd.read_csv(path + '\\dicom_metadata\\Dataset_Mammography_AI_dicom_metadata.csv')
...
output_df.to_csv(r"..\..\data\AI\output\Dataset_Mammography_AI.csv", index = False)
